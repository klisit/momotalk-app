  ...
  >
    <div class="dialog-box" @click.stop="">
      ...
      <div class="featured">
        ...
        <div class="page">
          <div class="dialog-content">
            <label>{{ $t('warnSave') }}</label
            ><br />
            <h2>{{ $t('sharedFile') }}</h2>
            <span style="display: flex; justify-content: space-evenly">
              <button class="button-half" @click="exportCard">
                {{ $t('exportButton') }}</button
              ><br />
              <button class="button-half" @click="importCard">
                {{ $t('importButton') }}</button
              ><br />
            </span>
            <h2>{{ $t('chatToArona') }}</h2>
            <label>{{ $t('warnCost') }}</label
            ><br />
            <label>API Key: </label>
            <input
              type="text"
          ...
          <p class="dialog-content">
            ...
            <a href="./Arona" title="talk to A.R.O.N.A"
              ><img class="arona-chat" src="/Arona.webp"
            /></a>
          </p>
        </div>
      </div>
